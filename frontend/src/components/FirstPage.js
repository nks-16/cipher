            ...
            <main className="flex-grow flex items-center justify-center px-6 py-10 relative z-10"> {/* Add z-10 to bring content above the overlay */}
                ...
                <div className="w-full max-w-3xl p-8 md:p-12 bg-blue-900 bg-opacity-0 rounded-2xl shadow-xl text-center mb-12"> {/* Increased bottom margin to mb-12 */}
                    ...
                    <div className="mb-4 text-left">
                        <label htmlFor="username" className="block text-white text-sm md:text-base font-semibold mb-2"style={{fontFamily: "'Agency FB',sans-serif"}}>
                            Username:
                        </label>
                        <input
                            id="username"
                    ...
                    <div className="mb-6 text-left">
                        <label htmlFor="password" className="block text-white text-sm md:text-base font-semibold mb-2"style={{fontFamily: "'Agency FB',sans-serif"}}>
                            Password:
                        </label>
                        <input
                            id="password"
